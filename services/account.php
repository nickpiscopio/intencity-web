<?php
	...
	else
	{
		...
		//Create the account.
		mysqli_multi_query($conn, "INSERT INTO User (" . COLUMN_EMAIL . ", " . COLUMN_CREATED_DATE . " , " . COLUMN_FIRST_NAME . ", " . COLUMN_LAST_NAME . ",  " . COLUMN_PASSWORD . ", " . COLUMN_ACCOUNT_TYPE . ", " . COLUMN_EARNED_POINTS . ", " . COLUMN_SHOW_WELCOME . ") VALUES 
