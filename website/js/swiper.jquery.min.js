...
! function() {
    ...
    var a, t = function(e, s) {
        ...
        var f = {};
        for (var h in s)
            if ("object" != typeof s[h] || null === s[h] || (s[h].nodeType || s[h] === window || s[h] === document || "undefined" != typeof Dom7 && s[h] instanceof Dom7 || "undefined" != typeof jQuery && s[h] instanceof jQuery)) f[h] = s[h];
            else {
                f[h] = {};
        ...
        if (y.params = s, y.originalParams = f, y.classNames = [], "undefined" != typeof a && "undefined" != typeof Dom7 && (a = Dom7), ("undefined" != typeof a || (a = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (y.$ = a, y.currentBreakpoint = void 0, y.getActiveBreakpoint = function() {
            ...
            var T, x, S, C, z, M, P, I, k, E, D = "input, select, textarea, button",
                L = Date.now(),
                H = [];
                    ...
                    if (e.originalEvent && (e = e.originalEvent), S && y.emit("onTouchEnd", y, e), S = !1, T) {
                        ...
                        if (r = y.params.followFinger ? y.rtl ? y.translate : -y.translate : -M, y.params.freeMode) {
                            ...
                            if (y.params.freeModeMomentum) {
                                ...
                                if (u < y.maxTranslate()) y.params.freeModeMomentumBounce ? (u + y.maxTranslate() < -f && (u = y.maxTranslate() - f), c = y.maxTranslate(), m = !0, E = !0) : u = y.maxTranslate();
                                else if (u > y.minTranslate()) y.params.freeModeMomentumBounce ? (u - y.minTranslate() > f && (u = y.minTranslate() + f), c = y.minTranslate(), m = !0, E = !0) : u = y.minTranslate();
                        ...
                        setTranslate: function() {
                            for (var e = y.translate, t = y.isHorizontal() ? -e + y.width / 2 : -e + y.height / 2, s = y.isHorizontal() ? y.params.coverflow.rotate : -y.params.coverflow.rotate, r = y.params.coverflow.depth, i = 0, n = y.slides.length; n > i; i++) {
                                var o = y.slides.eq(i),
                                    ...
                                    h = y.isHorizontal() ? y.params.coverflow.stretch * d : 0;
